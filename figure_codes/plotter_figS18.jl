...
DNA_data = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/modified_DNA_post_peak.xlsx","Sheet1";infer_eltypes=true))
...
# xlabel = Label(fig[5, :], "Time since peak (days)");
# ylabel = Label(fig[2:3, 0], "log SIV DNA", rotation = pi/2);
fig
save("fig_S18.svg", fig, px_per_unit = 6)

...
# Read the data file
df_data = DataFrame(CSV.File("../../figure_data_files/v9_files/master_data_exVivo_coculture.csv"));

# Read the parameter file
# Parameter order (Total 9): β_hat_exp, δ, ρ, p, c, f, μ_exp, T0_exp, V0_exp
df_param = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/parameters_model_exVivo_coculture.xlsx","Sheet1";infer_eltypes=true))

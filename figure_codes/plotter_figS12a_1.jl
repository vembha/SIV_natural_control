...
# Read the data file
df = DataFrame(XLSX.readtable("fig_S12a_1_data.xlsx","Sheet1",infer_eltypes=true));
...
fig
if idx == 1
    save("fig_S12a_1_1.svg", fig, px_per_unit = 6)
elseif idx == 2
    save("fig_S12a_1_2.svg", fig, px_per_unit = 6)
elseif idx == 3
    save("fig_S12a_1_3.svg", fig, px_per_unit = 6)
end

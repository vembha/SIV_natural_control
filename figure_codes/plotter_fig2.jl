...
ordering_idx = [3, 4, 5, 15]; # Order in which subplots must be placed
...
for i = 1:1:4 # Number of rows of panels
    for j = 1:1:1 # Number of macaques per row
...
fig
save("fig_2.svg", fig, px_per_unit = 6)

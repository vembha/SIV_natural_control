...
df_param = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/parameters_model_3.xlsx","Sheet1";infer_eltypes=true))
...
for i = 1:1:16
    ...
    prob = ODEProblem(model_3!,curr_init,tspan,curr_p)
...
fig
save("fig_S3.svg", fig, px_per_unit = 6)

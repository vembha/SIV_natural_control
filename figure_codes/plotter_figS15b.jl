...
#================================
FIGURE 15B: CORRELATION PLOT 
OF <AUC> OF kE VS SPVL BY MODEL 
WITHOUT S AND CONSTANT k
================================#
...
fig
save("fig_S15b.svg", fig, px_per_unit = 6)

# Write the data to .xlsx file

XLSX.openxlsx("fig_S15b_data.xlsx", mode = "rw") do xf
    sheet = xf[1]
    XLSX.writetable!(sheet, [VLf_m6, AUC_m6], ["spVL", "tAUC"])
end

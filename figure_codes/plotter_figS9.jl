...
# Parameter order (Total 13): λ, β_prime_exp, fD, λE⁺_exp, μI, μD, r, αE, θE, μE, ω_exp, T0_exp, η_str
df_param = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/parameters_model_1_nonCytolytic.xlsx","Sheet1";infer_eltypes=true))
...
for i = 1:1:16
    ...
    curr_p    = Vector{Float64}(df_param[i,2:14])

...
df_param = DataFrame(XLSX.readtable("../figure_data_files/parameters_model_1_sans_S.xlsx","Sheet1";infer_eltypes=true))
...
for i = 1:1:16
    ...
    curr_p    = Vector{Float64}(df_param[i,2:12])
...
fig
save("fig_S9.svg", fig, px_per_unit = 6)

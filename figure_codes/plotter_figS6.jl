...
df_param = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/parameters_model_1_sans_omega.xlsx","Sheet1";infer_eltypes=true))
...
for i = 1:1:16
    ...
    prob = ODEProblem(model_1_sans_omega!,curr_init,tspan,curr_p)
...
fig
save("fig_S6.svg", fig, px_per_unit = 6)

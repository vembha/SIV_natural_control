...
df_param = DataFrame(XLSX.readtable("../../figure_data_files/v9_files/parameters_model_1_lin_k.xlsx","Sheet1";infer_eltypes=true))
...
for i = 1:1:16
    ...
    prob = ODEProblem(model_1_lin_k!,curr_init,tspan,curr_p)
...
fig
save("fig_R_linear_k.svg", fig, px_per_unit = 6)

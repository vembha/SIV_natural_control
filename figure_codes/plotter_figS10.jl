...
# Parameter order (Total 11): λ, β_hat_exp, fD, λE⁺_exp, dI, dD, r, αE, θE, dE, T0_exp
df_param_SIC = DataFrame(XLSX.readtable("../figure_data_files/parameters_model_1_sans_S.xlsx","Controllers";infer_eltypes=true))
df_param_VIR = DataFrame(XLSX.readtable("../figure_data_files/parameters_model_1_sans_S.xlsx","Progressors";infer_eltypes=true))
...
fig
save("fig_S10.svg", fig, px_per_unit = 6)

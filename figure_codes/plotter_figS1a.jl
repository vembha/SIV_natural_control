...
# Read the data file
df_data = DataFrame(CSV.File("../figure_data_files/master_data_exVivo.csv"));

# Read the parameter file
# Parameter order (Total 9): β_hat_exp, δ, ρ, p, c, f, μ_exp, T0_exp, V0_exp
df_param = DataFrame(XLSX.readtable("../figure_data_files/parameters_model_exVivo.xlsx","Sheet1";infer_eltypes=true))
